...
- (IBAction)signupAction:(id)sender {
    ...
    [[FootblAPI sharedAPI] createAccountWithSuccess:^{
        [[FootblAPI sharedAPI] updateAccountWithUsername:self.username email:self.email password:self.password fbId:self.fbId profileImage:self.profileImage success:^{
