...
- (void)loadView {
    ...
    UIButton *askFriendsButton = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frameHeight - 196, self.view.frameWidth, 71)];
    ...
    UIButton *purchaseButton = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frameHeight - 133, self.view.frameWidth, 71)];
    ...
    UIButton *cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frameHeight - 71, self.view.frameWidth, 71)];
